...
namespace Secucard.Connect.Channel
{
    ...
    public interface IChannel
    {
        ...
        /**
   * Open the chann el and its resources.
   */
   ...
   */
        T GetObject<T>(string objectId, Func<T> callback);
   ...
   */
        ObjectList<T> FindObjects<T>(QueryParams queryParams, Func<ObjectList<T>> callback);
